...
export const AddAccounts = () => {
    ...
    return (
        <>
            <motion.button className={styles.addAccounts} whileTap={{scale: 0.97}}
                           onClick={() => setIsOpen(prevState => !prevState)} initial={false}
                           animate={isOpen ? 'open' : 'closed'}>
                <motion.span variants={{open: {rotate: 45}, closed: {rotate: 0}}}><PlusIcon/></motion.span>
                <motion.div
